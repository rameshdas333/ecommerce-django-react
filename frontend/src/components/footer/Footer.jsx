...
export default function Footer() {
  return (
    <footer className="bg-black text-white py-9 px-5 ">
      <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-5 gap-10 border-b border-gray-700 pb-10">
        ...
        <div>
          ...
          <div className="flex mt-10 items-center border border-gray-500 rounded px-2 py-1 w-full ">
            <input
              type="email"
              placeholder="Enter your email"
              className="bg-black text-gray-300 placeholder-gray-500 focus:outline-none px-2 w-full min-w-0 text-sm"
            />
